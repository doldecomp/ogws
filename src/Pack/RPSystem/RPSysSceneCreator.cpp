...
const RPSysSceneCreator::SceneAttr RPSysSceneCreator::SCENE_ATTR_TABLE[] = {
    ...
    {ESceneID_RPCowScene,                   EPackID_PartyPack,  ECreateType_Sibling,  ELoadType_Blank, EExitType_Standard, EAudioType_Scene,  "RPCowScene/",           /* Charge!                      */ "牛レース"},
    {ESceneID_RPWlyScene,                   EPackID_PartyPack,  ECreateType_Sibling,  ELoadType_Blank, EExitType_Standard, EAudioType_Scene,  "RPWlyScene/",           /* Find Mii                     */ "ウォーリー  "},
    {ESceneID_RPTnkScene,                   EPackID_PartyPack,  ECreateType_Sibling,  ELoadType_Blank, EExitType_Standard, EAudioType_Scene,  "RPTnkScene/",           /* Tanks!                       */ "タンク"},
    {ESceneID_RPBomScene,                   EPackID_PartyPack,  ECreateType_Sibling,  ELoadType_Blank, EExitType_Standard, EAudioType_Scene,  "RPBomScene/",           /* Pose Mii                     */ "爆弾"},
