...
void DrawPathLightMap::draw(u16 idx) {
    ...
    case 1:
        ...
        if (BUF_0x8C) {
            ...
            DrawGX::DrawScreenTexture(forDL, DrawGX::WHITE);
            BUF_0x8C->free();
            BUF_0x8C = NULL;
        }
    ...
    case 3:
        ...
        if (BYTE_0x7D != 0) {
            ...
            nw4r::math::MTX34 forDL;
            PostEffectBase::setProjection(GetScreen());
            PSMTXScale(forDL, GetScreen().GetWidth(), GetScreen().GetHeight(),
                       1.0f);
            ...
            if (BUF_0x88 != NULL) {
                ...
                DrawGX::SetMat_ColorChannel(DrawGX::COLORCHAN_COLOR);
                DrawGX::SetMat_TexGen(DrawGX::TEXGEN_ENABLE);
                DrawGX::SetMat_Ind();
                ...
                if (WORD_0x80 == 0) {
                    ...
                    GXSetTevAlphaIn(GX_TEVSTAGE0, GX_CA_TEXA, GX_CA_KONST,
                                    GX_CA_RASA, GX_CA_ZERO);
                    GXSetTevAlphaOp(GX_TEVSTAGE0, GX_TEV_COMP_A8_GT, GX_TB_ZERO,
                                    GX_CS_SCALE_1, 1, GX_TEVPREV);
                } else {
                    GXSetTevKAlphaSel(GX_TEVSTAGE0, GX_TEV_KASEL_K0_A);
                    GXSetTevOrder(GX_TEVSTAGE0, GX_TEXCOORD0, GX_TEXMAP0,
                ...
                DrawGX::SetZMode(DrawGX::ZMODE_OPA);
                GXSetZCompLoc(0);
            ...
            DrawGX::DrawDL(DrawGX::DL_SCREEN_TEXTURE, forDL, tevColor);
