...
private:
    ...
    typedef ut::LinkList<Pane, offsetof(PaneBase, node)> _PaneList;
...
private:
    void Init();
    void InsertChild(_PaneList::Iterator next, Pane* pChild);
};
