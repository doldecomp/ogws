...
class StateGX {
public:
    enum StateFlags { USE_TMEM = 0x10, VALID_CACHE = 0x20 };
    ...
    struct ScopedColorUpdate {
        ScopedColorUpdate(bool x) {
    ...
    struct ScopedAlphaUpdate {
        ScopedAlphaUpdate(bool x) {
    ...
    struct ScopedDitherUpdate {
        ScopedDitherUpdate(bool x) {
            old = sCache.dither;
            GXSetDither_(x);
        }
...
public:
    ...
    static UNKWORD getDefaultPixelFormatArg2() {
        return sDefaultPixelFormatArg2;
    }
    ...
    static void setEfbWidth(u16 w) {
        s_widthFb = w;
    }
    static u16 getEfbHeight() {
        return s_heightEfb;
    }
    static void setEfbHeight(u16 h) {
        s_heightEfb = h;
    }
